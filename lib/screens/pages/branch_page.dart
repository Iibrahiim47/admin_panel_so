...
class _BranchPageState extends State<BranchPage> {
  ...
  @override
  void initState() {
    print(GetBranchListController.to.allBranchList);
        ...
        child: Form(
          ...
          child: Column(
            children: [
                      ...
                      InkWell(
                        onTap: () {
                          if (formKey.currentState!.validate()) {
                            ...
                            AddBranchController.to
                                .addBranchPMethiod(model)
                                .then((value) {});
                            ...
                            MyFlushBar.showSimpleFlushBar("Added successfully",
              ...
              const Divider(),
              GetBuilder<GetBranchListController>(builder: (obj) {
                return Expanded(
                  child: SizedBox(
                    height: height,
                    width: width,
                    // color: Colors.amber,
                    child: obj.allBranchList.isEmpty
                        ...
                        : GridView.builder(
                            ...
                            itemCount:
                                GetBranchListController.to.allBranchList.length,
                                          ...
                                          Expanded(
                                            child: Container(
                                              ...
                                              child: Row(
                                                ...
                                                children: [
                                                  Text(
                                                      "${obj.allBranchList[index].address}"),
                                                  SizedBox(
                                                    width: width * 0.03,
                                                    height: height * 0.06,
                                                    // color: Colors.amber,
